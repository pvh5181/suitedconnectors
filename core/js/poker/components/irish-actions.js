...
export class IrishActionsComponent extends React.Component {
    onChangeBet(amt) {
...
export const IrishActions = reduxify({
    ...
    render: (props) => props.can_act ? <IrishActionsComponent {...props}/> : null
})
