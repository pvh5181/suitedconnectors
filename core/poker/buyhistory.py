...
class BuyHistoryLog:
    ...
    @staticmethod
    def buy_history_to_frontend_dict(hand):
        table = hand['table']
        output = {
        ...
        return [
            {
                ...
                'summary': BuyHistoryLog.hand_history_to_frontend_dict(hand),
            }
            for hand in log['hands']
        ]
...
def fmt_eventline(for_player=None, **line):
    if 'event' in line:
        line = BuyHistoryLog.filter_cards(line, for_player)
