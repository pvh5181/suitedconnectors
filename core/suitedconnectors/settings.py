...
Order of precedence for all settings:
    ...
    2. env/dev.env  (or prod.env, beta.env, ci.env depending on SUITEDCONNECTORS_ENV)
    3. settings.py defaults (this file)

https://github.com/monadical-sas/suitedconnectors.poker/wiki/Configuration
"""
...
from suitedconnectors.system import (
...
SUITEDCONNECTORS_ENV = os.getenv('SUITEDCONNECTORS_ENV', 'DEV').upper()
check_system_invariants(SUITEDCONNECTORS_ENV)
...
STATIC_URL = '/static/'
SITE_ID = 1
WSGI_APPLICATION = 'suitedconnectors.wsgi.application'
...
ENV_SETTINGS_FILE = os.path.join(ENV_DIR, f'{SUITEDCONNECTORS_ENV.lower()}.env')
...
### Security Settings
################################################################################
SESSION_ENGINE = 'django.contrib.sessions.backends.cached_db'   # extended by suitedconnectors.models.UserSession
...
SUPPORT_GIVERS = [
    # 'max+support@suitedconnectors.com',
    'admin@suitedconnectors.com',
    # 'ana+support@suitedconnectors.com',
]
...
TABLES_PAGE_MINIMUM_TABLES = 1             # Used to keep a minimum number of tables for tables page
...
# settings set via env/SUITEDCONNECTORS_ENV.env
...
AUTH_USER_MODEL = 'suitedconnectors.User'
ROOT_URLCONF = 'suitedconnectors.urls'
...
MIDDLEWARE = [
    'suitedconnectors.middleware.http2_middleware.HTTP2PushMiddleware',
    'suitedconnectors.middleware.x_forwarded_for.XForwardedForMiddleware',
...
DEBUG_TOOLBAR_CONFIG = {
    ...
    'SHOW_TOOLBAR_CALLBACK': 'suitedconnectors.utils.debug_toolbar_callback',
}
...
PIWIK_SETUP = {
    'tracked_domain': '*.suitedconnectors.com',
...
LOGGING = {
    ...
    'handlers': {
        ...
        'sentry': {
            ...
            'tags': {'SUITEDCONNECTORS_ENV': SUITEDCONNECTORS_ENV, 'DEBUG': DEBUG},
        },
        'mail_admins': {
            'level': 'ERROR',
