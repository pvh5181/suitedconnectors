...
def get_evn_setup(host):
    ...
    target = host or os.environ.get('SUITEDCONNECTORS_URL', DEFAULT_TEST_TARGET)
    ...
    return {
        'SUITEDCONNECTORS_URL': f'{protocol}://{host}{port_str}',
        'SUITEDCONNECTORS_WS_URL': f'{ws_protocol}://{host}{port_str}',
