...
def split_hoststr(host_str: str, defaults=('http', '127.0.0.1', 8000)):
    ...
    e.g. https://suitedconnectors.com, 127.0.0.1:8000, or http://dev.local:8000
    """
...
def host_type(host_str: str):
    ...
    e.g. 127.0.0.1:8000, http://suitedconnectors.com, https://suitedconnectors.l
    """
...
def module_type(path_str: str):
    ...
    in this project e.g. ui.integration_tests, sockets, suitedconnectors.tests
    """
    if not path_str:
        return None
